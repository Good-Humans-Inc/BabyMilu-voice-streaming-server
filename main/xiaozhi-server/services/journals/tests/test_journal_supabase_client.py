...
def test_legacy_specific_memory_event_env_is_fallback_not_first(monkeypatch):
    monkeypatch.setenv("SUPABASE_CHARACTER_MEMORY_EVENT_TABLE", "character_memory_event")
    monkeypatch.delenv("SUPABASE_MEMORY_EVENT_TABLE", raising=False)
    monkeypatch.setenv("SUPABASE_URL", "https://example.supabase.co")
    monkeypatch.setenv("SUPABASE_SERVICE_ROLE_KEY", "service-role")
...
def test_custom_specific_memory_event_env_is_respected(monkeypatch):
